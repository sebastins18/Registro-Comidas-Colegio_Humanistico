...
<head>
  ...
  <title>Registro Comidas Meriendas</title>
...
<body>
  ...
  <h1 class="titulo">Merienda</h1>
  <form class="formulario" action="Registro_Comidas_Estudiantes_Merienda.php" method="POST" autocomplete="off">
    <label class="etiquetas" >Buscar Estudiante</label>
    <input class="input-text" type="text" name="identificacion">
    ...
    <?php
       if(isset($_POST['identificacion']) && isset($_POST['buscar'])){
        require_once "php/php/connect.php";
        require_once "php/procesos/buscarMerienda.php";
...
if (isset($_POST['identificacion']) && isset($_POST['registrar_Merienda'])){
  require_once "php/php/connect.php";
  require_once "php/procesos/guardarMerienda.php";
  require_once "php/procesos/buscarMerienda.php";
   }
      ?>
