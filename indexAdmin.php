  ...
  <h1 class="titulo">Inicio</h1>
      <form action="indexAdmin.php" method="POST">
        <?php
            ...
            require_once "adminLlenarTablas.php";
            
        ?>
        <div class="boton__tabla">
            <input type="submit" name="boton" class="boton inverso" value="Enviar">
        </div>
      ...
      <?php
          if(isset($_POST['boton'])){
              require_once "php/php/connect.php";
              require_once "php/procesos/guardarMenuSemana.php";
            }    
            ?>
