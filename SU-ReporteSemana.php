...
<body>
    <header>
        ...
        <form  action="SU-ReporteSemana.php" method="POST" autocomplete="off">
        <input class="boton inverso" type="submit" name="generar_reporteSemana"  value="Generar Reporte Semanal"/>
        </form>
       
        <?php

     if(isset($_POST['generar_reporteSemana'])){
    
        require_once "php/php/connect.php";
		require_once "php/procesos/generarReporteSemana.php";
