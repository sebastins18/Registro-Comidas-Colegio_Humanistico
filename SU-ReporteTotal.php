...
<body>
    <header>
        ...
        <form  action="SU-ReporteTotal.php" method="POST" autocomplete="off">
        <input class="boton inverso" type="submit" name="generar_reportetotal" value="Generar Reporte total"/>
        </form>
       
        <?php

     if(isset($_POST['generar_reportetotal'])){
    
      require_once "php/php/connect.php";
			require_once "php/procesos/generarReporteTotal.php";
