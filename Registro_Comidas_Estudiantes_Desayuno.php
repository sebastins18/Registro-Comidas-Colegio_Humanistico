...
<head>
  ...
  <title>Registro Comidas Desayuno</title>
...
<ul class="navbar-nav me-auto mb-2 mb-lg-0">
  ...
  <h1 class="titulo">Desayuno</h1>
  
  <form class="formulario" action="Registro_Comidas_Estudiantes_Desayuno.php" method="POST" autocomplete="off">
    ...
    <?php
       if(isset($_POST['identificacion']) && isset($_POST['buscar'])){
        ...
        require_once "php/procesos/buscarDesayuno.php";
...
if (isset($_POST['identificacion']) && isset($_POST['registrar_Desayuno'])){
  require_once "php/php/connect.php";
  require_once "php/procesos/guardarDesayuno.php";
  require_once "php/procesos/buscarDesayuno.php";
   }
      ?>
